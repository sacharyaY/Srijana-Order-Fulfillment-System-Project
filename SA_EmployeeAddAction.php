<?php
	...
	$sqlString = "INSERT INTO  Employee VALUES ('" . $_POST["EmployeeID"] ."','" . $_POST["EmployeeFname"] ."','" . $_POST["EmployeeLname"] ."','" . $_POST["EmployeePassword"] ."','" . $_POST["EmployeeEmail"] ."')" ;
...
<html>
	<head>
    	<title> SA_EmployeeAddAction.php</title>
    </head>
	<body bgcolor="#bbccaa">
		<br/><br/><br/>
		<center>
